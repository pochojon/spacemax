let spmxmenu=`
        ...
        <div class="logo" >
            <a href="index.html">
               SPACE<font color="red" size=6 ><b>/</b></font>MAX
            </a>
        </div>
...
document.getElementById("idmenu").innerHTML=spmxmenu;
...
<footer class="footer-distributed">
    <div class="footer-left">
        ...
        <h3><span>SPACE<font color="red" size=6 ><b>/</b></font>MAX</span></h3>

        <p class="footer-links">
            <a href="index.html">Home</href>
            |    
            <a href="nosotros.html">Nosotros</href>
            |   
            <a href="propiedades.html">Propiedades</href>
            |     
            <a href="contacto.html">Contacto</href>
            |    
        </p>
...
document.getElementById("idfooter").innerHTML=spmxfooter;
